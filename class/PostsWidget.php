...
class PostsWidget extends WP_Widget
{
	...
	public function form($instance)
	{
		...
		//
		?>
		<div class="_stool-posts-widget-config">
			...
			<r-grid columns=12>
				...
				<r-cell span=7>
					<div>
						<label for="<?php echo $this->get_field_id('title_link'); ?>"><?php _e('Link'); ?>:</label>
			...
			<r-grid columns=12 data-stool-post-selects="<?php echo $uuid; ?>">
				<r-cell span=5>
					<div>
				...
				<r-cell span=5>
					<div>
						<label for="<?php echo $this->get_field_id('type'); ?>"><?php _e('Category'); ?>:</label>
			...
			<r-grid columns=6>
				...
				<r-cell span=3>
					<div>
						<label for="<?php echo $this->get_field_id('sortway'); ?>"><?php _e('Order'); ?>:</label>
				...
				<r-cell span=row>
					<div>
						...
						<label for="<?php echo $this->get_field_id('ignoresticky'); ?>"><?php _e('Ignore pinned posts'); ?></label>
					</div>
				</r-cell>
				<r-cell span=row>
					<div>
						...
						<label for="<?php echo $this->get_field_id('ignorequeried'); ?>"><?php _e('Ignore already queried posts'); ?></label>
					</div>
				</r-cell>
			</r-grid>

			<r-grid columns=6 class="danger">
				<r-cell span=row>
					<p>
						<strong>Expert settings</strong><br>
						Please edit this ony if you know what you are doing.
					</p>
					<div>
